...
- nublado/parcialmente nublado: Pelotas com céu variável.
...
Os ativos otimizados ficam em `public/weather/hero/`. Quando a câmera ao vivo da Praia do Laranjal está online, ela mantém prioridade sobre a fotografia estática.
