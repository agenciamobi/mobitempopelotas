...
const megaMenus: MegaMenuDefinition[] = [
  {
    ...
    featured: {
      ...
      href: "/",
      description: "Temperatura, sensação, chuva, vento e a evolução das próximas horas.",
    },
    sections: [
      {
        title: "Planeje o dia",
  ...
  },
  {
    id: "monitoring",
    label: "Monitoramento",
    activePaths: ["/estacao-embrapa-pelotas", "/historico-climatico-pelotas", "/metodologia"],
    featured: {
      eyebrow: "Imagens oficiais",
      label: "Radar e satélite da região",
      href: "/#regiao",
      description: "Acompanhe chuva, nuvens e trovoadas com os produtos integrados ao portal.",
    },
    sections: [
      {
...
function isActivePath(pathname: string, href: string) {
  ...
  if (href === "/situacao-hidrologica-pelotas") {
    return pathname.startsWith(href) || pathname.startsWith("/nivel-da-lagoa-dos-patos-laranjal");
  }
...
export function SiteHeader({ advisoryLevel = "normal", variant = "default" }: SiteHeaderProps) {
  ...
  return (
    <>
      ...
      <header ref={headerRef} className={headerClassName} data-advisory-level={advisoryLevel}>
            ...
            return (
              <div
                ...
                onKeyDown={(event) => {
                  ...
                  setOpenMenu(null);
                  event.currentTarget.querySelector<HTMLElement>(".mega-nav-trigger")?.focus();
                }}
              >
                <button
                ...
                <div className="mega-menu-panel" id={`mega-menu-${menu.id}`} aria-hidden={!isOpen}>
