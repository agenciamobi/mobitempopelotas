...
export function HomeForecastEditorial({ weather, narrative }: HomeForecastEditorialProps) {
  ...
  return (
    <section className="tp-home-forecast" id="previsao-hoje" aria-labelledby="tp-home-forecast-title">
      ...
      <section className="tp-home-forecast-week" aria-labelledby="tp-home-forecast-week-title">
        <header className="tp-home-forecast-week__header">
          <span>Tendência do tempo</span>
          <h3 id="tp-home-forecast-week-title">Como o tempo deve evoluir na semana</h3>
        </header>

        <div className="tp-home-forecast-week__list">
          {nextDays.map((day, index) => {
            ...
            return (
              <article
                className={`tp-home-forecast-day${isRainiest ? " is-rainiest" : ""}`}
              ...
              >
                <div className="tp-home-forecast-day__topline">
                  <div>
                ...
                <div className="tp-home-forecast-day__condition">
                  <WeatherIcon name={day.icon} title={condition} />
                  <span>{condition}</span>
                </div>
                <div className="tp-home-forecast-day__summary">
                  <strong>{summary.headline}</strong>
                  <p>{summary.summary}</p>
                </div>
                <dl className="tp-home-forecast-day__metrics">
                  <div>
                    <dt>Chuva</dt>
        ...
        <div className="tp-home-forecast__links">
